...
function T() {
    ...
    !function n() {
        ...
        }, i.id, s.config.maxWait, 100, s.config.crawlDelay, function(e) {
...
function I() {
    ...
    $("#crawlDelay").bind("propertychange change click keyup input paste", function() {
        ...
        p("", "inputError"),
        s.config.crawlDelay = parseInt(1e3 * e),
        S()
    }),
    $("#maxWait").bind("propertychange change click keyup input paste", function() {
        ...
        p("", "inputError"),
        s.config.maxWait = parseInt(1e3 * e),
        S()
    }),
    $("#resetColumns").click(function() {
        s.config.deletedFields = {},
        S(),
        $("#resetColumns").hide(),
        v()
    }),
...
function q() {
    $("#stats").empty().append($("<div>", {
        text: "Pages scraped: " + s.pages
    })).append($("<div>", {
        text: "Rows collected: " + s.data.length
    })).append($("<div>", {
        text: "Rows from last page: " + s.lastRows
    })).append($("<div>", {
